...
export default function DetailView() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        if (id) {
          const caseDetailsResponse = await pb
            .collection("cases")
            .getOne(id, { expand: "case_activity_item(case)" });
          ...
          if (caseDetailsResponse) {
            ...
            if (caseDetailsResponse.expand) {
              activity_items =
                (caseDetailsResponse as any).expand[
                  "case_activity_item(case)"
                ] || [];
          ...
          <TabPanel value={0}>
            ...
            >
              <Accordion>
                ...
                <AccordionDetails>
                  <SurgeryDetails
                    surgeryDetails={caseDetails.surgery_scheduled[0]}
                  />
                </AccordionDetails>
              </Accordion>
            </AccordionGroup>
          ...
          <TabPanel value={1}>
            ...
            >
              <ActivityLogComponent
                case_activity_item={caseDetailsNew?.activity_items || []}
              />
            </AccordionGroup>
          </TabPanel>
          <TabPanel value={2}>
